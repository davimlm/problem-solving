...
# O resto da divisão deve ser calculado usando o operador % (módulo). Para isso, basta:
# a = 10
# b = 3
# resto = a % b
...
print ("quadrado de", a, ": ", aQuadrado)
print ("cubo de", a, ": ", aCubo)
print ("resto de ", b, "por ", c, ": ", cResto)